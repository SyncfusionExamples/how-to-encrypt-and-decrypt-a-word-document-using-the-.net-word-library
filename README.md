# How to Encrypt and Decrypt a Word Document Using the Syncfusion&reg; .NET Word Library
A quick start project that shows how to Encrypt and Decrypt a Word document using the Syncfusion&reg; [.NET Word library](https://www.syncfusion.com/document-processing/word-framework/net/word-library?utm_source=github&utm_medium=listing&utm_campaign=github-docio-video-examples).
...
- **Documentation:** [Encrypt and Decrypt the Word documents](https://help.syncfusion.com/file-formats/docio/working-with-security?utm_source=github&utm_medium=listing&utm_campaign=github-docio-video-examples)
